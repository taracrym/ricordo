        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ background:"#F5F5F7", padding:"14px 20px 4px", display:"flex", justifyContent:"space-between", alignItems:"center", flexShrink:0, position:"relative" }}>
              ...
              <span style={{ fontSize:"11px", fontWeight:600, color:"#1A2744", zIndex:1 }}>9:05</span>
              <div style={{ display:"flex", gap:"5px", alignItems:"center", zIndex:1 }}>
                <svg width="15" height="11" viewBox="0 0 15 11" fill="none">
                  <rect x="0" y="6" width="3" height="5" rx="0.5" fill="#1A2744"/>
                  <rect x="4" y="4" width="3" height="7" rx="0.5" fill="#1A2744"/>
                  <rect x="8" y="2" width="3" height="9" rx="0.5" fill="#1A2744"/>
                  <rect x="12" y="0" width="3" height="11" rx="0.5" fill="#1A2744" opacity="0.3"/>
                </svg>
                <svg width="14" height="11" viewBox="0 0 14 11" fill="none">
                  <path d="M7 2.5C9.2 2.5 11.1 3.4 12.5 4.8L14 3.3C12.2 1.5 9.7 0.5 7 0.5C4.3 0.5 1.8 1.5 0 3.3L1.5 4.8C2.9 3.4 4.8 2.5 7 2.5Z" fill="#1A2744"/>
                  <path d="M7 5.5C8.4 5.5 9.6 6.1 10.5 7L12 5.5C10.7 4.2 9 3.5 7 3.5C5 3.5 3.3 4.2 2 5.5L3.5 7C4.4 6.1 5.6 5.5 7 5.5Z" fill="#1A2744"/>
                  <circle cx="7" cy="9.5" r="1.5" fill="#1A2744"/>
                </svg>
                <svg width="22" height="11" viewBox="0 0 22 11" fill="none">
                  <rect x="0.5" y="0.5" width="18" height="10" rx="2.5" stroke="#1A2744" strokeOpacity="0.35"/>
                  <rect x="2" y="2" width="14" height="7" rx="1.5" fill="#1A2744"/>
                  <path d="M19.5 3.5v4a1.5 1.5 0 0 0 0-4z" fill="#1A2744" fillOpacity="0.4"/>
                </svg>
              </div>
            </div>
            ...
            <div style={{ flex:1, overflowY:"hidden", background:"white" }}>
              ...
              <div style={{ padding:"14px 16px 8px", borderBottom:"1px solid #F0F0F0" }}>
                <div style={{ fontWeight:700, fontSize:"14px", color:"#1A2744", lineHeight:1.3, marginBottom:"10px" }}>
                  Your content is ready! ⭐
                </div>
                {/* Sender */}
                <div style={{ display:"flex", gap:"10px", alignItems:"flex-start" }}>
                  <div style={{ width:"34px", height:"34px", borderRadius:"50%", flexShrink:0, background:"#1A2744", display:"flex", alignItems:"center", justifyContent:"center" }}>
                  ...
                  <div>
                    <div style={{ display:"flex", gap:"6px", alignItems:"center" }}>
                      <span style={{ fontWeight:600, fontSize:"12px", color:"#1A2744" }}>Tara</span>
              ...
              <div style={{ margin:"0 16px 8px", padding:"10px 12px", background:"#F5F5F7", borderRadius:"10px" }}>
                <div style={{ display:"flex", gap:"10px", alignItems:"center", marginBottom:"10px" }}>
                  ...
                  <div>
                    <div style={{ fontWeight:600, fontSize:"11px", color:"#1A2744" }}>YourBrand_Content</div>
                ...
                <div style={{ display:"flex", flexDirection:"column", gap:"2px" }}>
                  {files.map((f, i) => (
                    <div key={i} style={{
                      ...
                      <span style={{ fontSize:"11px", color:"#1A2744", fontWeight: lit === i ? 600 : 400, flex:1 }}>{f.name}</span>
              ...
              <div style={{ margin:"0 16px 10px" }}>
                <div style={{
                  ...
                  fontSize:"12px", color:"#1A2744", letterSpacing:"0.02em",
                }}>
                  View Content →
                </div>
              </div>
